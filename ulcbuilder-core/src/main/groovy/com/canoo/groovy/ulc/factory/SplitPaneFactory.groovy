...
public class SplitPaneFactory extends AbstractFactory {
    ...
    public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
        if (FactoryBuilderSupport.checkValueIsType(value, name, ULCSplitPane.class)) {
            return value;
        }
        ULCSplitPane answer = new ULCSplitPane();
    ...
    public void setChild(FactoryBuilderSupport factory, Object parent, Object child) {
        ...
        if (parent.getOrientation() == ULCSplitPane.HORIZONTAL_SPLIT) {
