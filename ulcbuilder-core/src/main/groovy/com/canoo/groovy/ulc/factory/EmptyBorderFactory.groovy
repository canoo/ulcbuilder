 ...
 *
 */
class EmptyBorderFactory extends ULCBorderFactory {
    ...
    public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
        ...
        if (value == null) {
            int top = (int)attributes.remove("top")
            int left = (int)attributes.remove("left")
            int bottom = (int)attributes.remove("bottom")
            int right = (int)attributes.remove("right")
