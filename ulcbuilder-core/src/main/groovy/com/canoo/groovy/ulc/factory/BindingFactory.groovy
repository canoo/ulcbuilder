...
import com.canoo.groovy.ulc.binding.*
import org.codehaus.groovy.binding.*

public class BindingFactory extends AbstractFactory {

    public static final String CONTEXT_DATA_KEY = "BindingFactoryData";
    ...
    public BindingFactory() {
        ...
        // covers ULCTextField.text
        // covers ULCTextPane.text
        // covers ULCTextArea.text
        // covers ULCEditorPane.text
        syntheticBindings.putAll(ULCTextComponentProperties.getSyntheticProperties())

        // covers ULCCheckBox.selected
        // covers ULCChecBoxMenuItem.selected
        // covers ULCRadioButton.selected
        // covers ULCRadioButtonMenuItem.selected
        // covers ULCToggleButton.selected
        syntheticBindings.putAll(ULCAbstractButtonProperties.syntheticProperties)

        // covers ULCSlider.value
        syntheticBindings.putAll(ULCSliderProperties.getSyntheticProperties())

        // covers ULCScrollBar.position
        syntheticBindings.putAll(ULCScrollBarProperties.getSyntheticProperties())

        // ULCComboBox.selectedElement / selectedIndex
        syntheticBindings.putAll(ULCComboBoxProperties.getSyntheticProperties())

        // ULCList.selectedIndex / selectedIndices
        // ULCList.selectedValue / selectedValues
        syntheticBindings.putAll(ULCListProperties.getSyntheticProperties())

        // ULCSpinner.value
        syntheticBindings.putAll(ULCSpinnerProperties.getSyntheticProperties())

        // other properties handled in JSR-295
        // JTable.elements
        // JTable.selectedElement
        // JTable.selectedElements
        syntheticBindings.putAll(ULCTableProperties.getSyntheticProperties());
    ...
    public bindingAttributeDelegate(FactoryBuilderSupport builder, def node, def attributes) {
        ...
        while (iter.hasNext()) {
            ...
            def idAttr = builder.getAt(ULCBuilder.DELEGATE_PROPERTY_OBJECT_ID) ?: ULCBuilder.DEFAULT_DELEGATE_PROPERTY_OBJECT_ID
