...
public class DialogFactory extends RootPaneContainerFactory {
    ...
    public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
        ULCDialog dialog
        if (FactoryBuilderSupport.checkValueIsType(value, name, ULCDialog.class)) {
            dialog = (ULCDialog)value
        } else {
            ...
            if (owner instanceof ULCWindow) {
                dialog = new ULCDialog((ULCWindow) owner)
            } else {
