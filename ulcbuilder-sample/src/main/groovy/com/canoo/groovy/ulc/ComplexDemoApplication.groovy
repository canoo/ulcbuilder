...
public class ComplexDemoApplication extends AbstractApplication {
...
//        frame.pack()
  ...
  public static void run(Closure view) {
    def localContainer = [getApplicationClass:{->ComplexDemoApplication.class}] as LocalContainerAdapter
    localContainer.start()
  }

  public static void main(String[] args) {
    println "In order to run this Demo, make sure it is referenced in the ULCApplicationConfiguration."
    println "A deployment-key.jar must be on the classpath."
    ComplexDemoApplication.run {}
  }
